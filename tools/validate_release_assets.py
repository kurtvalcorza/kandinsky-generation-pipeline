...
REPO_NAME = "kandinsky-generation-pipeline"
NOTEBOOK_NAME = "kandinsky_generation_colab.ipynb"
EXPECTED_PROFILE = "E2E"
EXPECTED_MODEL_ID = "kandinsky-community/kandinsky-2-2-decoder"
...
EXPECTED_OUTPUTS = (
    ...
    "outputs/kandinsky_generation_adapted_grid.jpg",
    "outputs/kandinsky_generation_evaluation_report.json",
    "outputs/kandinsky_generation_adapter",
    "outputs/kandinsky_generation_result.json",
)
CODE_MARKERS = (
    "use_lora=True)",
    ...
    "write_dataset_csv(test_records, 'outputs/kandinsky_generation_sample_captions.csv')",
